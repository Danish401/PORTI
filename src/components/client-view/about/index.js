...
export default function ClientAboutView({ data }) {
  ...
  // Safely split skills string and provide a default empty array
    ...
    >
            ...
            >
              <div className="flex m-0 w-40 sm:w-auto">
                <div className="flex flex-col">
                  ...
                  <p className="text-[25px] font-bold text-[#2C94C0]">
                    {infoItem.label}
                  </p>
                </div>
              </div>
      ...
      <AnimationWrapper className={"pt-6"}>
        <div className="flex flex-col justify-center items-center row-start-2 sm:row-start-1">
          ...
          <p className="text-[#2C94C0] mt-4 mb-8 font-bold">{data?.aboutme}</p>
        </div>
      </AnimationWrapper>
      <div className="grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-2 gap-8">
        <AnimationWrapper className="flex w-full">
          ...
          >
            {skills.map((skill, index) => (
              <motion.div
                ...
                variants={skillItemVariant}
              >
                <button className="whitespace-nowrap text-ellipsis overflow-hidden py-3 w-[160px] px-6 border-[2px] border-[#6C2DC7] bg-[#fff] text-[#2C94C0] font-semibold rounded-lg text-xl tracking-widest hover:shadow-[#6C2DC7] transition-all outline-none">
                  {skill}
                </button>
              </motion.div>
            ))}
